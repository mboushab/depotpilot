-- Reassign any box currently reserved to available before dropping the enum value
UPDATE "StorageUnit" SET "status" = 'AVAILABLE' WHERE "status" = 'RESERVED';

-- Recreate UnitStatus without RESERVED
